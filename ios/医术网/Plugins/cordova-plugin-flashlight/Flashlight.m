...
- (void)mkShareLinkToWx:(CDVInvokedUrlCommand*)command {
    [WXApi registerApp:@"wx4c16435946da293d" withDescription:@"medku1.0"];
...
{
    WXMediaMessage *message = [WXMediaMessage message];
    message.title = @"医术网 (Medku) ";
    message.description = @"医术网 (Medku) 是一个面向外科医生的专业交流和分享网站，旨在帮助中国外科医生更好的成长，打造属于外科医生的专属平台。";
    [message setThumbImage:[UIImage imageNamed:@"ionic3.png"]];
    
    WXWebpageObject *ext = [WXWebpageObject object];
    ext.webpageUrl = @"http://www.medku.com";
